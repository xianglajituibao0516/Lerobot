...
def _iter_pyav_frames(video_path: str, timestamp: float):
    import av
...
def decode_video_frames_torchvision(
    ...
    if backend == "pyav":
        # Recent torchvision versions no longer expose VideoReader.
        reader = _iter_pyav_frames(video_path, first_ts)
    else:
