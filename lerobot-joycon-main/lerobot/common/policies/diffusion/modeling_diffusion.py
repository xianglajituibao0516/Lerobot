...
from lerobot.common.policies.diffusion.CNN_diffusion import DiffusionConditionalUnet1d
...
class DiffusionModel(nn.Module):
    ...
    def generate_actions(self, batch: dict[str, Tensor]) -> Tensor:
        ...
        # Encode image features and concatenate them all together along with the state vector.
        global_cond = self._prepare_global_conditioning(batch)  # (B, To, cond_dim) if use transformer else (B, global_cond_dim)
